                ...
                {userInfo.postDocId ? (
                        ...
                        className={`flex flex-col items-center left-2 h-full`}>
                            <div className="w-full relative">
                                ...
                                className={`rounded-full p-1 cursor-pointer w-8 absolute right-2 top-2`} viewBox="0 0 24 24">
                                ...
                                className="flex flex-col items-center w-3/5 mt-10 pb-10">
                                    <img className="w-full max-h-full max-w-full object-cover rounded-md shadow-2xl mb-5" src="/images/6.jpg" alt="profile" />
