...
import { getUserByEmailEncrypted, getDocFirstImage, getUserByUserId } from "../services/firebase";
...
import { windowRatioAction } from "../redux";
...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        getUserByUserId(contextUser.uid).then((res: any) => {
            setMe(res)
        })
    }, [])
    ...
    return (
        <div className="z-0 w-full flex flex-col items-center">
            ...
            <AnimateSharedLayout type="crossfade">
                ...
                {me && <div className="w-full">
                    <Header userInfo={userInfo} me={me}/>
                </div>}
                    ...
                    {!loading ?
                        (<>
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity : 1 }}
                                className="flex col-span-7 items-start justify-between mt-12">
                                {/* Profile Image Div */}
                                <div className="flex mr-3 w-1/3 items-center justify-between">
                                ...
                                <div className="flex flex-col w-2/3 ml-5 h-full justify-around">
                                    ...
                                    {/* Caption */}
                                    <p className="font-noto text-sm text-gray-400 whitespace-pre-line">{userInfo.profileCaption}</p>
                                </div>
                                
                            </motion.div>
                            
                            {/* Posts list */}
                            <div className={`flex justify-center ${windowRatio > 1 ? "col-span-3 col-start-3" : "col-span-5 col-start-2"} py-12 border-b-2`}>
                                <span className="text-4xl font-noto">Posts</span>
                            </div>
                            <div className={`grid grid-cols-3 gap-3 ${windowRatio > 1 ? "col-span-5 col-start-2" : "col-span-7"} items-start mt-6`}>
                            ...
                            <div className="flex justify-center col-span-3 col-start-3 py-12 border-b-2">
