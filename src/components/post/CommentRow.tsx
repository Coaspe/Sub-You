...
<div className="flex flex-col bg-gray-50 px-3 rounded-xl font-noto py-2 shadow-lg w-10/12">
    <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
            <svg x="0px" y="0px" className="w-5 mr-2 cursor-pointer" fill="gray" viewBox="0 0 544.582 544.582">
                <g>
                    <path
            ...
            <svg className="w-5 cursor-pointer" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                <path clip-rule="evenodd" d="M16 15H0V12L7 0H9L16 12V15ZM7 4H9V9H7V4ZM7 11H9V13H7V11Z" fill="gray"
